                    ...
                    <div class="col-12">
                        <div class="d-flex">
                            <div class="dropdown-as-select me-3" data-setActive="false" data-childSelector="span">
                                <a class="pe-0 pt-0 align-top lh-1 dropdown-toggle" href="#"
                                    data-bs-toggle="dropdown" aria-expanded="false" aria-haspopup="true">
                                    <span class="small-title"></span>
                                </a>
                                <div class="dropdown-menu font-standard">
                                    <div class="nav flex-column" role="tablist">
                                        <a class="active dropdown-item text-medium" href="#"
                                            aria-selected="true" role="tab">Today's</a>
                                    ...
                                    <div class="card-body pt-0 pb-0 h-100">
                                        <div class="row g-0 h-100 align-content-center">
                                            <div
                                                ...
                                                <a href="Orders.Detail.html" class="body-link stretched-link">Order
                                                    #54129</a>
                                            </div>
                                            <div
                                            ...
                                            <div
                                                class="col-12 col-md-2 d-flex align-items-center mb-1 mb-md-0 text-alternate">
                                                <span>
                                            ...
                                            <div class="row g-0 mb-2">
                                                <div class="col-auto">
                                                    <div
                                                        ...
                                                        <div class="sh-3">
                                                            <i data-cs-icon="circle"
                                                                class="text-primary align-top"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                            ...
                                            <div class="row g-0 mb-2">
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="card-body d-flex flex-column pt-0 pb-0 ps-3 pe-4 h-100 justify-content-center">
                                                        <div class="d-flex flex-column">
                                                            <div class="text-alternate mt-n1 lh-1-25">3 new product
                                                                added</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row g-0 mb-2">
                                                <div class="col-auto">
                                                    <div
                                                        class="sw-3 d-inline-block d-flex justify-content-start align-items-center h-100">
                                                        <div class="sh-3">
                                                            <i data-cs-icon="square"
                                                                class="text-secondary align-top"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                            ...
                                            <div class="row g-0 mb-2">
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="card-body d-flex flex-column pt-0 pb-0 ps-3 pe-4 h-100 justify-content-center">
                                                        <div class="d-flex flex-column">
                                                            <div class="text-alternate mt-n1 lh-1-25">Category page
                                                                returned an error</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                                            ...
                                            <div class="row g-0 mb-2">
                                                <div class="col-auto">
                                                    <div
                                                        class="sw-3 d-inline-block d-flex justify-content-start align-items-center h-100">
                                                        <div class="sh-3">
                                                            <i data-cs-icon="hexagon"
                                                                class="text-tertiary align-top"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div class="text-alternate mt-n1 lh-1-25">
                                                                New sale:
                                                                <a href="#"
                                                                    class="alternate-link underline-link">Steirer
                                                                    Brot</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div class="text-alternate mt-n1 lh-1-25">
                                                                New sale:
                                                                <a href="#"
                                                                    class="alternate-link underline-link">Soda
                                                                    Bread</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row g-0 mb-2">
                                                <div class="col-auto">
                                                    <div
                                                        class="sw-3 d-inline-block d-flex justify-content-start align-items-center h-100">
                                                        <div class="sh-3">
                                                            <i data-cs-icon="triangle"
                                                                class="text-warning align-top"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div class="text-alternate mt-n1 lh-1-25">
                                                                New sale:
                                                                <a href="#"
                                                                    class="alternate-link underline-link">Cholermüs</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div class="text-alternate mt-n1 lh-1-25">
                                                                New sale:
                                                                <a href="#"
                                                                    class="alternate-link underline-link">Bazlama</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row g-0 mb-2">
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="card-body d-flex flex-column pt-0 pb-0 ps-3 pe-4 h-100 justify-content-center">
                                                        <div class="d-flex flex-column">
                                                            <div class="text-alternate mt-n1 lh-1-25">Recived an email
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body mb-n2 scroll-out h-100">
                                        <div class="scroll h-100">
                                            <div class="row g-0 sh-10 mb-3">
                                                <div class="col-auto">
                                                    <a href="Products.Detail.html">
                                                        <img src="img/product/small/cornbread.jpg"
                                                            class="card-img rounded-md h-100 sw-8" alt="thumb" />
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div class="mb-1">
                                                                <a href="Products.Detail.html" class="body-link">Soda
                                                                    Bread</a>
                                                                <span class="text-muted">by</span>
                                                                <a href="Customers.Detail.html"
                                                                    class="body-link">Kathleen Bertha</a>
                                                            </div>
                                            ...
                                            <div class="row g-0 sh-10 mb-3">
                                                <div class="col-auto">
                                                    <a href="Products.Detail.html">
                                                        <img src="img/product/small/panettone.jpg"
                                                            class="card-img rounded-md h-100 sw-8" alt="thumb" />
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div class="mb-1">
                                                                <a href="Products.Detail.html"
                                                                    class="body-link">Barmbrack</a>
                                                                <span class="text-muted">by</span>
                                                                <a href="Customers.Detail.html"
                                                                    class="body-link">Kathleen Bertha</a>
                                                            </div>
                                                            <div class="text-small text-muted text-truncate mb-1">Bear
                                                                claw sweet liquorice jujubes. Muffin gingerbread bear
                                                                claw.</div>
                                                            <div class="br-wrapper br-theme-cs-icon">
                                                                <select class="rating" name="rating"
                                                                    autocomplete="off" data-readonly="true"
                                            ...
                                            <div class="row g-0 sh-10 mb-3">
                                                <div class="col-auto">
                                                    <a href="Products.Detail.html">
                                                        <img src="img/product/small/buccellato-di-lucca.jpg"
                                                            class="card-img rounded-md h-100 sw-8" alt="thumb" />
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div class="mb-1">
                                                                <a href="Products.Detail.html"
                                                                    class="body-link">Fougasse</a>
                                                                <span class="text-muted">by</span>
                                                                <a href="Customers.Detail.html" class="body-link">Olli
                                                                    Hawkins</a>
                                                            </div>
                                                            <div class="text-small text-muted text-truncate mb-1">Bear
                                                                claw sweet liquorice jujubes. Muffin gingerbread bear
                                            ...
                                            <div class="row g-0 sh-10">
                                                <div class="col-auto">
                                                    <a href="Products.Detail.html">
                                                        <img src="img/product/small/pullman-loaf.jpg"
                                                            class="card-img rounded-md h-100 sw-8" alt="thumb" />
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div class="mb-1">
                                                                <a href="Products.Detail.html"
                                                                    class="body-link">Steirer Brot</a>
                                                                <span class="text-muted">by</span>
                                                                <a href="Customers.Detail.html" class="body-link">Zayn
                                                                    Hammond</a>
                                                            </div>
                                                            <div class="text-small text-muted text-truncate mb-1">Chupa
                                                                chups candy canes.</div>
                                                            <div class="br-wrapper br-theme-cs-icon">
                                                                <select class="rating" name="rating"
                                                                    autocomplete="off" data-readonly="true"
                                                                    data-initial-rating="5">
                                ...
                                <div class="col-12 d-flex flex-column justify-content-between align-items-start">
                                    <div>
                                        ...
                                        <div class="text-muted mb-4">
                                            Cheesecake chocolate carrot cake pie lollipop apple pie lemon cream
                                            lollipop.
                                            <br />
                            ...
                            <div class="scroll-by-count" data-count="4">
                                ...
                                <div class="card mb-2">
                                    <div class="row g-0 sh-14 sh-md-10">
                                        <div class="col-auto">
                                            <a href="Products.Detail.html">
                                                <img src="img/product/small/cornbread.jpg" alt="user"
                                                    class="card-img card-img-horizontal sw-11" />
                                            </a>
                                        </div>
                                        <div class="col">
                                ...
                                <div class="card mb-2">
                                    <div class="row g-0 sh-14 sh-md-10">
                                        <div class="col-auto">
                                            <a href="Products.Detail.html">
                                                <img src="img/product/small/boule.jpg" alt="user"
                                                    class="card-img card-img-horizontal sw-11" />
                                            </a>
                                        </div>
                                        <div class="col">
